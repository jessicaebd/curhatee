            ...
            <div class="d-flex">
                <ul class="d-flex navbar">
                    <li class="nav-link d-flex">
                        ...
                        $lang = App::getLocale();
                        ?>
                        <a class="nav-link p-1 {{ ($lang != null) & ($lang == 'en') ? 'active' : '' }}"
                            href="/lang/en">EN</a>
                        <span>|</span>
                        <a class="nav-link p-1  {{ ($lang != null) & ($lang == 'id') ? 'active' : '' }}"
                            href="/lang/id">ID</a>
                    </li>

                    @if (Route::has('login'))
                        <button type="button" class="btn btn-blue" data-bs-toggle="modal" data-bs-target="#loginModal">
                            {{ __('Login') }}
                        </button>
                    ...
                    @if (Route::has('register'))
                        <button type="button" class="btn btn-outline-light ms-2" data-bs-toggle="modal"
...
@elseif (Auth::check())
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar border">
                <ul>
                    <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
                    <li><a class="nav-link scrollto" href="#about">About</a></li>
                    <li class="dropdown"><a href="#features"><span>Features</span> <i
            ...
            <div class="d-flex align-items-center border">
                <ul class="d-flex align-items-center navbar">
                    <li class="nav-link ">
                        <?php
                        $lang = App::getLocale();
                        ?>
